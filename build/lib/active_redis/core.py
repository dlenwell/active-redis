...
from active_redis.registry import DataType as DataTypeRegistry
from active_redis.registry import Observable as ObservableRegistry
from active_redis.exception import *
import uuid
...
class ActiveRedisClient(object):
  ...
  def _is_redis_value(self, value):
    ...
    return value.startswith(bytearray(self.REDIS_STRUCTURE_PREFIX))
